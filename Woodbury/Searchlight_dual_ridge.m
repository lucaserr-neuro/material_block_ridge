    ...
    base_path = 'base/path';
    spm_file = sprintf('path/to/SPM.mat',base_path,s);
    
    % load data
    tool_mask = 'path/to/tool/mask.nii';
    brain_mask =  sprintf('path/to/brain/mask', base_dir,s,s);
   ...
   % % condition masks
    ...
    tic;%s/forFilipa/fmriprep/sub-%02d/func/sub-%02d_task-01ep2dboldprftools_space-MNI152NLin2009cAsym_res-2_desc-brain_mask.nii.gz
...
%p_logged map
ds_b = cosmo_fmri_dataset(sprintf('path/to/sub/beta_0001.nii',base_path,s),'mask', brain_mask);
